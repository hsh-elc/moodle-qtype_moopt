...
$string['missingcreatecapability'] = 'The MooPT question type requires special permission, which can be granted by your Moodle administrator.';
$string['moopt:create'] = 'Create MooPT questions';
