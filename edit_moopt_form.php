...
//            $mform->setType("freetextinputfieldtemplate$i", PARAM_RAW);
    ...
    protected function data_preprocessing($question) {
        ...
        if (isset($question->id)) {
            ...
            if (empty($fs->get_area_files($this->context->id, 'question', $sourcefilearea, $question->id))) {
                $sourcefilearea = PROFORMA_TASKXML_FILEAREA;
            }
            file_prepare_draft_area($draftitemid, $this->context->id, 'question', $sourcefilearea,
